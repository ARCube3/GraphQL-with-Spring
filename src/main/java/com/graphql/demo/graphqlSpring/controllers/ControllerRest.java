...
//	}
	...
	//Get all participants and details
	...
	@GetMapping("participantDetailsById/{participantId}")
	public ParticipantDTO getPartcipantDetails(@PathVariable int participantId) {
		return this.partservice.getPartcipantDetails(participantId);
	}
